...
export const BirthdayCakeIcone = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      preserveAspectRatio="xMidYMid meet"
    ...
    >
      <mask id="svgIDa">
        <g fill="none">
          <path fill="#fff" d="M8 40h32V24H8v16Z" />
          <path
            stroke="#fff"
            strokeLinecap="round"
          ...
          <path
            ...
            strokeLinejoin="round"
            strokeWidth="4"
            d="m40 34l-4-2l-4 2l-4-2l-4 2l-4-2l-4 2l-4-2l-4 2"
          />
          <path
            stroke="#fff"
            strokeLinecap="round"
  ...
  return (
    ...
    >
      <g fill="none">
        ...
        <path
          fill="currentColor"
          d="M12 17a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm0-7a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm0-7a2 2 0 1 1 0 4a2 2 0 0 1 0-4Z"
        />
      </g>
    </svg>
  );
...
export const PencilEditicon = () => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="m232.5 55.5l-32-32a12 12 0 0 0-17 0l-96 96A11.9 11.9 0 0 0 84 128v32a12 12 0 0 0 12 12h32a12.3 12.3 0 0 0 8.5-3.5l96-96a12 12 0 0 0 0-17ZM192 49l15 15l-11 11l-15-15Zm-69 99h-15v-15l56-56l15 15Zm105-19.4V208a20.1 20.1 0 0 1-20 20H48a20.1 20.1 0 0 1-20-20V48a20.1 20.1 0 0 1 20-20h79.4a12 12 0 0 1 0 24H52v152h152v-75.4a12 12 0 0 1 24 0Z"
      />
    </svg>
  );
};
...
export const ArrowBottomDropdown = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      preserveAspectRatio="xMidYMid meet"
